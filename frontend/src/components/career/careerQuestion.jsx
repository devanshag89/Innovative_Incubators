        ...
        <main className="flex flex-col items-center mt-28 w-full px-4">
          ...
          {showResult ? (
            ...
            >
              ...
              {/* <button
                onClick={restartQuiz}
                className="bg-purple-600 text-white px-4 py-2 rounded-lg mt-6 hover:bg-indigo-600"
              >
                Restart Quiz
              </button> */}
              <Link to="/skillfront">
              <button
                className="bg-purple-600 text-white px-4 ml-4 py-2 rounded-lg mt-6 hover:bg-indigo-600"
              >
                Go Ahead
              </button>
              </Link>
